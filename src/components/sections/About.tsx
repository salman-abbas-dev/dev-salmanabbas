      ...
      <div style={{ width: "100%" }}>
        ...
        >
          ...
          >
            ...
            >
              I am a Software Engineer and passionate Full Stack Developer focused on building robust, scalable web applications. Bridging the gap between clean, responsive frontend interfaces and backend architectures built for high performance, I specialize in modern technologies like React, Next.js, Node.js, and Go. My goal is to transform complex problems into intuitive digital experiences that are both visually engaging and structurally sound.
            </motion.p>
            ...
            >
              {/* DOWNLOAD CV */}
              <a
                href="https://drive.google.com/file/d/1zRgPci9_yQo5V5UsMJXoda4maRM8tKJ5/view?usp=sharing"
                target="_blank"
