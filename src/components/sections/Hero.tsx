    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <TextType
              text={["Junior Programmer", "Happy coding!"]}
              typingSpeed={75}
              pauseDuration={1500}
              showCursor
              cursorCharacter="_"
        ...
        >
          ...
          >
            Crafting robust full-stack applications from the ground up. I bridge the gap between dynamic, high-performance backends and clean, intuitive frontend designs.
          </p>
        </motion.div>
